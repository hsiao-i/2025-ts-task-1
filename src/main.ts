...
export type CalcTotalFn = /* TODO: (參數型別) => 型別 */ {
...
export function updatePlant(input: /* TODO */ Partial<PlantBase>): /* TODO */ Required<PlantBase> {
  const existing: /* TODO */ PlantBase = { id: 1, name: "虎尾蘭", price: 480, description: "耐陰、淨化空氣" };
...
// 說明：用 Record 表示庫存表。
// 目標：以字串鍵對應到嚴格結構。
export type Inventory = /* TODO */ "PLANT-1001" | "PLANT-2001";
export const inventory: Record<Inventory, number> /* TODO */ = {
  "PLANT-1001": 42,
  "PLANT-2001": 8,
};
...
export type TProduct = CreateProduct | UpdateProduct;

export const submitProduct = (type: TProductType, product: TProduct): string => {
  if (type === "create") {
